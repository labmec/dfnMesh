...
public:
    ...
    DFNFracture* CreateFracture(DFNPolygon &Polygon, int indexFromJson, FracLimit limithandling = Eextended, int materialid = DFNMaterial::Efracture, int nreffracborder = -1, REAL sizeOfEdgesTouchFracBorder = -1.);
