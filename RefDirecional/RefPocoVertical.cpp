...
int main()
{
    ...
    {
        std::ofstream out("gmesh3dVertical.vtk");
    ...
    }
    {
        ...
        for(int el=0; el<numel; el++)
        {
            ...
            nodes[0] = (nelx[0]+1)*el+(nelx[0])/2;
            nodes[1] = (nelx[0]+1)*(el+1)+(nelx[0])/2;
            int matid = 2;
            int64_t index;
        ...
        {
            std::ofstream out("gmesh3dVerticalbis.vtk");
            TPZVTKGeoMesh::PrintGMeshVTK(gmesh3d, out, true);
        }
    }
    ...
    {
        std::ofstream out("gmesh3dVerticaltris.vtk");
        TPZVTKGeoMesh::PrintGMeshVTK(gmesh3d, out, true);
    }
    {
    ...
    {
        std::ofstream out("gmesh3dVerticalquater.vtk");
        TPZVTKGeoMesh::PrintGMeshVTK(gmesh3d, out, true);
    }
